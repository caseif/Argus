...
#[script_bind]
pub fn get_gamepad_name(gamepad: HidDeviceInstanceId) -> String {
...
#[script_bind]
pub fn is_gamepad_button_pressed(gamepad: HidDeviceInstanceId, button: &GamepadButton) -> bool {
...
#[script_bind]
pub fn get_gamepad_axis(gamepad: HidDeviceInstanceId, axis: &GamepadAxis) -> f64 {
    let Some(gamepad_state) = InputManager::instance().gamepad_states.get(&gamepad) else {
        println!("Client polled unknown gamepad ID {}", gamepad);
        return 0.0;
    };
...
#[script_bind]
pub fn get_gamepad_axis_delta(gamepad: HidDeviceInstanceId, axis: &GamepadAxis) -> f64 {
    let Some(gamepad_state) = InputManager::instance().gamepad_states.get(&gamepad) else {
        println!("Client polled unknown gamepad ID {}", gamepad);
        return 0.0;
    };
