...
impl Controller {
    ...
    pub fn attach_gamepad(&mut self, id: HidDeviceInstanceId) {
    ...
    pub fn unbind_action(&mut self, action: impl AsRef<str>) {
        let Some(bound_keys) = self.bindings.action_to_keys.get(action.as_ref()) else { return; };
        ...
        self.bindings.action_to_keys.remove(action.as_ref());
    }
    ...
    pub fn bind_keyboard_key(&mut self, key: KeyboardScancode, action: impl AsRef<str>) {
        Self::bind_thing(
    ...
    pub fn unbind_keyboard_key_action(&mut self, key: &KeyboardScancode, action: impl AsRef<str>) {
        Self::unbind_thing(
            &mut self.bindings.key_to_actions,
            &mut self.bindings.action_to_keys,
            key,
    ...
    pub fn bind_mouse_axis(&mut self, axis: MouseAxis, action: impl AsRef<str>) {
        Self::bind_thing(
    ...
    pub fn unbind_mouse_axis_action(&mut self, axis: &MouseAxis, action: impl AsRef<str>) {
        Self::unbind_thing(
            &mut self.bindings.mouse_axis_to_actions,
            &mut self.bindings.action_to_mouse_axes,
            axis,
    ...
    pub fn bind_gamepad_button(&mut self, button: GamepadButton, action: impl AsRef<str>) {
        Self::bind_thing(
    ...
    pub fn bind_gamepad_axis(&mut self, axis: GamepadAxis, action: impl AsRef<str>) {
        Self::bind_thing(
    ...
    pub fn unbind_gamepad_axis_action(&mut self, axis: &GamepadAxis, action: impl AsRef<str>) {
        Self::unbind_thing(
            &mut self.bindings.gamepad_axis_to_actions,
            &mut self.bindings.action_to_gamepad_axes,
            axis,
    ...
    pub fn is_action_pressed(&self, action: impl AsRef<str>) -> bool {
        if let Some(key_bindings) = self.bindings.action_to_keys.get(action.as_ref()) {
        ...
        if let Some(mouse_bindings) = self.bindings.action_to_mouse_buttons.get(action.as_ref()) {
    ...
    pub fn get_action_axis(&self, action: impl AsRef<str>) -> f64 {
        let mut max_value: f64 = 0.0;
        if self.has_gamepad() {
            if let Some(gamepad_bindings) =
                self.bindings.action_to_gamepad_axes.get(action.as_ref()) {
                max_value = max_abs(
                    max_value,
        ...
        if let Some(mouse_bindings) = self.bindings.action_to_mouse_axes.get(action.as_ref()) {
            max_value = max_abs(
                max_value,
                mouse_bindings.iter()
    ...
    pub fn get_action_axis_delta(&self, action: impl AsRef<str>) -> f64 {
        let mut max_value: f64 = 0.0;
        if self.has_gamepad() {
            if let Some(gamepad_bindings) =
                self.bindings.action_to_gamepad_axes.get(action.as_ref()) {
