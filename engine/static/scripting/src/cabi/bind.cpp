...
static argus::Result<argus::ObjectWrapper, argus::ReflectiveArgumentsError> _unwrap_res(
        const ArgusObjectWrapperOrReflectiveArgsError &res) {
    if (res.is_err) {
        return argus::err<argus::ObjectWrapper, argus::ReflectiveArgumentsError>(
                argus::ReflectiveArgumentsError { res.err });
    } else {
        return argus::ok<argus::ObjectWrapper, argus::ReflectiveArgumentsError>(
                *reinterpret_cast<argus::ObjectWrapper *>(res.val));
    }
}
