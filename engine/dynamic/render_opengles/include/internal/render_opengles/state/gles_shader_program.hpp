...
namespace argus {
    ...
    class GLESShaderProgram {
        public:
             ...
             *        new program with.
             */
            GLESShaderProgram(const std::vector<const Shader*> &shaders);
             ...
             *        new program with.
             */
            GLESShaderProgram(const std::initializer_list<const Shader*> &shaders):
                    GLESShaderProgram(std::vector<const Shader*>(shaders)) {
            }
