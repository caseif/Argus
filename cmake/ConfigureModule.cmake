...
function(_argus_configure_module MODULE_PROJECT_DIR ROOT_DIR
  ...
  set(MODULE_PROP_C_COMPILE_OPTIONS_GCC "c_compile_options_gcc")
  set(MODULE_PROP_C_COMPILE_OPTIONS_MSVC "c_compile_options_msvc")
  set(MODULE_PROP_CXX_COMPILE_OPTIONS_GCC "cxx_compile_options_gcc")
  set(MODULE_PROP_CXX_COMPILE_OPTIONS_MSVC "cxx_compile_options_msvc")
  ...
  foreach(line ${MODULE_PROPS_LINES})
    ...
    if(NOT ${span_lines})
      ...
      elseif("${cur_key}" STREQUAL "${MODULE_PROP_C_COMPILE_OPTIONS_GCC}")
        string(REPLACE "," ";" cur_value "${cur_value}")
        list(APPEND MODULE_C_COMPILE_OPTIONS_GCC "${cur_value}")
      elseif("${cur_key}" STREQUAL "${MODULE_PROP_C_COMPILE_OPTIONS_CLANG}")
        string(REPLACE "," ";" cur_value "${cur_value}")
        list(APPEND MODULE_C_COMPILE_OPTIONS_CLANG "${cur_value}")
      elseif("${cur_key}" STREQUAL "${MODULE_PROP_C_COMPILE_OPTIONS_MSVC}")
        string(REPLACE "," ";" cur_value "${cur_value}")
        list(APPEND MODULE_C_COMPILE_OPTIONS_MSVC "${cur_value}")
      elseif("${cur_key}" STREQUAL "${MODULE_PROP_CXX_COMPILE_OPTIONS_GCC}")
        string(REPLACE "," ";" cur_value "${cur_value}")
        list(APPEND MODULE_CXX_COMPILE_OPTIONS_GCC "${cur_value}")
      elseif("${cur_key}" STREQUAL "${MODULE_PROP_CXX_COMPILE_OPTIONS_CLANG}")
        string(REPLACE "," ";" cur_value "${cur_value}")
        list(APPEND MODULE_CXX_COMPILE_OPTIONS_CLANG "${cur_value}")
      elseif("${cur_key}" STREQUAL "${MODULE_PROP_CXX_COMPILE_OPTIONS_MSVC}")
        string(REPLACE "," ";" cur_value "${cur_value}")
        list(APPEND MODULE_CXX_COMPILE_OPTIONS_MSVC "${cur_value}")
      endif()
    endif()
  endforeach()
  ...
  if("${MODULE_TYPE}" STREQUAL "${MODULE_TYPE_DYNAMIC}")
    if(${IS_EXTERNAL})
      if(${IS_RUST})
        ...
        corrosion_add_target_local_rustflags("${PROJECT_NAME}" "--cfg" "feature=\"generate_bindings\"")
  ...
  if(${IS_EXTERNAL})
    ...
    set(is_cc_gcc "$<C_COMPILER_ID:GNU>")
    set(is_cxx_gcc "$<CXX_COMPILER_ID:GNU>")
    set(is_cc_clang "$<C_COMPILER_ID:Clang>")
    set(is_cxx_clang "$<CXX_COMPILER_ID:Clang>")
    set(is_cc_msvc "$<C_COMPILER_ID:MSVC>")
    set(is_cxx_msvc "$<CXX_COMPILER_ID:MSVC>")
    set(is_lang_c "$<COMPILE_LANGUAGE:C>")
    set(is_lang_cxx "$<COMPILE_LANGUAGE:CXX>")
    target_compile_options("${PROJECT_NAME}" PRIVATE "$<$<AND:${is_cc_gcc},${is_lang_c}>:${MODULE_C_COMPILE_OPTIONS_GCC}>")
    target_compile_options("${PROJECT_NAME}" PRIVATE "$<$<AND:${is_cxx_gcc},${is_lang_cxx}>:${MODULE_CXX_COMPILE_OPTIONS_GCC}>")
    target_compile_options("${PROJECT_NAME}" PRIVATE "$<$<AND:${is_cc_clang},${is_lang_c}>:${MODULE_C_COMPILE_OPTIONS_CLANG}>")
    target_compile_options("${PROJECT_NAME}" PRIVATE "$<$<AND:${is_cxx_clang},${is_lang_cxx}>:${MODULE_CXX_COMPILE_OPTIONS_CLANG}>")
    target_compile_options("${PROJECT_NAME}" PRIVATE "$<$<AND:${is_cc_msvc},${is_lang_c}>:${MODULE_C_COMPILE_OPTIONS_MSVC}>")
    target_compile_options("${PROJECT_NAME}" PRIVATE "$<$<AND:${is_cxx_msvc},${is_lang_cxx}>:${MODULE_CXX_COMPILE_OPTIONS_MSVC}>")
