function(_argus_set_compile_flags TARGET)
  if(MSVC)
    ...
    target_compile_options("${TARGET}" PUBLIC "-Werror" "-Wall" "-Wextra" "-Wold-style-cast" "-Woverloaded-virtual"
                           "-Wuninitialized" "-Wconversion" "-Wno-error=conversion"
                           "-Wno-error=sign-conversion")
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang"
       OR (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 10))
      target_compile_options("${TARGET}" PUBLIC "-Werror=mismatched-tags")
    endif()
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
      ...
      target_compile_options("${TARGET}" PUBLIC "-Wpedantic" "-Wno-gnu-zero-variadic-macro-arguments"
